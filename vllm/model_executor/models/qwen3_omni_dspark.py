...
backbone. It intentionally keeps the compact dense DSpark decoder and logical
1-D positions, while its Q/KV head counts and head dimension are required to
match the target text attention geometry. The standalone checkpoint therefore
has a distinct architecture contract from a generic Qwen3 DSpark checkpoint.
"""
